...
set src_files [list \
    ...
    [file join $root_dir "Slave_ip/v2_0/slave2_tx.v"] \
    [file join $root_dir "tb/tb_slave2_tx.v"] \
]
...
puts "INFO: slave2_tx xsim compile"
run_shell_command [concat [list cmd /c [file nativename $xvlog_cmd]] $src_files]

puts "INFO: slave2_tx xsim elaborate"
run_shell_command [list cmd /c [file nativename $xelab_cmd] tb_slave2_tx -s tb_slave2_tx_sim]

puts "INFO: slave2_tx xsim run"
run_shell_command [list cmd /c [file nativename $xsim_cmd] tb_slave2_tx_sim -runall]
