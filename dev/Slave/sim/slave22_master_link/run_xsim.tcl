...
# 컴파일 순서: Master leaf -> Slave reuse leaf -> slave22_timebase -> slave22_top -> tb
set files [list \
    ...
    [file join $repo_root "tb" "tb_slave22_master_link.v"] \
]
...
file delete -force tb_slave22_master_link_sim.wdb
file delete -force webtalk.jou
file delete -force webtalk.log

exec [file join $vivado_bin "xvlog.bat"] -log xvlog.log {*}$files
exec [file join $vivado_bin "xelab.bat"] tb_slave22_master_link -debug typical -s tb_slave22_master_link_sim -log xelab.log
exec [file join $vivado_bin "xsim.bat"] tb_slave22_master_link_sim -runall -log xsim.log
