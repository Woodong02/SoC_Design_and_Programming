...
set run_dir [file join $root sim slave22_comm_worst_case xsim_run]
file mkdir $run_dir
cd $run_dir
...
set sources [list \
    ...
    [file join $root tb tb_slave22_comm_worst_case.v] \
]
...
file delete -force tb_slave22_comm_worst_case_sim.wdb
file delete -force webtalk.jou
file delete -force webtalk.log

exec [file join $vivado_bin "xvlog.bat"] -log xvlog.log {*}$sources
exec [file join $vivado_bin "xelab.bat"] tb_slave22_comm_worst_case -debug typical -s tb_slave22_comm_worst_case_sim -log xelab.log
exec [file join $vivado_bin "xsim.bat"] tb_slave22_comm_worst_case_sim -runall -log xsim.log
