...
set files [list \
    ...
    [file join $repo_root "tb" "tb_slave22_top_full_serial.v"] \
]
set vivado_bin "C:/Xilinx/Vivado/2019.1/bin"

exec [file join $vivado_bin "xvlog.bat"] -log xvlog.log {*}$files
exec [file join $vivado_bin "xelab.bat"] tb_slave22_top_full_serial -debug typical -s tb_slave22_top_full_serial_sim -log xelab.log
exec [file join $vivado_bin "xsim.bat"] tb_slave22_top_full_serial_sim -runall -log xsim.log
