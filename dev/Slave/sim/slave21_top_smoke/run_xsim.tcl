...
set files [list \
    ...
    [file join $repo_root "tb" "tb_slave21_top_smoke.v"] \
]
set vivado_bin "C:/Xilinx/Vivado/2019.1/bin"

exec [file join $vivado_bin "xvlog.bat"] -log xvlog.log {*}$files
exec [file join $vivado_bin "xelab.bat"] tb_slave21_top_smoke -debug typical -s tb_slave21_top_smoke_sim -log xelab.log
exec [file join $vivado_bin "xsim.bat"] tb_slave21_top_smoke_sim -runall -log xsim.log
