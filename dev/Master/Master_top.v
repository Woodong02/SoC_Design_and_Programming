module master_top (
    ...
    assign seg_err_out[27:24] = NODE_CNT < 3'd1 ? 4'd9 : halt_cmd[1] ? 4'd2 : Silent_node[1] ? 4'd1 : 4'd0;
    assign seg_err_out[23:20] = NODE_CNT < 3'd2 ? 4'd9 : halt_cmd[2] ? 4'd2 : Silent_node[2] ? 4'd1 : 4'd0;
    assign seg_err_out[19:16] = NODE_CNT < 3'd3 ? 4'd9 : halt_cmd[3] ? 4'd2 : Silent_node[3] ? 4'd1 : 4'd0;
    assign seg_err_out[15:12] = NODE_CNT < 3'd4 ? 4'd9 : halt_cmd[4] ? 4'd2 : Silent_node[4] ? 4'd1 : 4'd0;
    assign seg_err_out[11:8] = NODE_CNT < 3'd5 ? 4'd9 : halt_cmd[5] ? 4'd2 : Silent_node[5] ? 4'd1 : 4'd0;
    assign seg_err_out[7:4] = NODE_CNT < 3'd6 ? 4'd9 : halt_cmd[6] ? 4'd2 : Silent_node[6] ? 4'd1 : 4'd0;
    assign seg_err_out[3:0] = NODE_CNT < 3'd7 ? 4'd9 : halt_cmd[7] ? 4'd2 : Silent_node[7] ? 4'd1 : 4'd0; 
