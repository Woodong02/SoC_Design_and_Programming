...
# IP: bd/system/ip/system_pushbutton_0_1/system_pushbutton_0_1.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==system_pushbutton_0_1 || ORIG_REF_NAME==system_pushbutton_0_1} -quiet] -quiet
