...
HD_PWD='C:/SoC_Design_and_Programming/Project/interrupt/interrupt.runs/system_pushbutton_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_pushbutton_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_pushbutton_0_1.tcl
