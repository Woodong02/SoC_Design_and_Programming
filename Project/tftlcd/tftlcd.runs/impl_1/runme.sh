...
HD_PWD='C:/SoC_Design_and_Programming/Project/tftlcd/tftlcd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TFTLCDctrl.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TFTLCDctrl.tcl -notrace
