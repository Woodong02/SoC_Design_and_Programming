...
HD_PWD='C:/SoC_Design_and_Programming/Project/tftlcd/tftlcd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TFTLCDctrl.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TFTLCDctrl.tcl
