...
HD_PWD='C:/SoC_Design_and_Programming/Project/ps_tftlcd/ps_tftlcd.runs/system_tftlcd_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_tftlcd_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_tftlcd_0_3.tcl
