...
HD_PWD='C:/work/2021115390/ps_digital_clock/ps_digital_clock.runs/system_textlcd_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log system_textlcd_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source system_textlcd_0_0.tcl
