...
module slave_cfg_shadow (
    ...
    // data_out0~5는 버튼 입력을 즉시 반영하기 위해 shadow/freeze를 거치지 않고 직접 통과시킨다.
    assign selected_data_out0   = reg_data_out0;
    assign selected_data_out1   = reg_data_out1;
    assign selected_data_out2   = reg_data_out2;
    assign selected_data_out3   = reg_data_out3;
    assign selected_data_out4   = reg_data_out4;
    assign selected_data_out5   = reg_data_out5;
