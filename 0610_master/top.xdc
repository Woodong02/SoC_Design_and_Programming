...
set_property IOSTANDARD "LVCMOS33" [get_ports "resetn_bt_0"]
set_property PACKAGE_PIN "Y18" [get_ports "resetn_bt_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "GPIO_in_0"]
set_property PACKAGE_PIN "F16" [get_ports "GPIO_in_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "GPIO_out_0"]
set_property PACKAGE_PIN "E16" [get_ports "GPIO_out_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "LED_out_0"]
set_property PACKAGE_PIN "T17" [get_ports "LED_out_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "LED_in_0"]
set_property PACKAGE_PIN "T16" [get_ports "LED_in_0"]

set_property IOSTANDARD "LVCMOS33" [get_ports "DIP_SW_0[*]"]
set_property PACKAGE_PIN "Y20"	[get_ports "DIP_SW_0[0]"]
set_property PACKAGE_PIN "Y21"	[get_ports "DIP_SW_0[1]"]
set_property PACKAGE_PIN "AB19"	[get_ports "DIP_SW_0[2]"]
set_property PACKAGE_PIN "AB20"	[get_ports "DIP_SW_0[3]"]
